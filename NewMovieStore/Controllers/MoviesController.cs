...
using NewMovieStore.Models;

namespace NewMovieStore.Controllers
{
    public class MoviesController : Controller
    {
        private NewMovieStoreDbContext db;

        //Used by Application

        public MoviesController()
        {
            this.db = new NewMovieStoreDbContext();
        }

        //Used only during Unit Testing

        public MoviesController(NewMovieStoreDbContext dbContext)
        {
            this.db = dbContext;
        }
